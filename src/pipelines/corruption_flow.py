...
def main() -> None:
    """Run the corruption, evaluation, repair, and comparison flow.
    ...
    # Repair always starts from the immutable raw snapshot, not from corrupted_df.
    ...
    print("Corruption, repair, and comparison flow completed")
